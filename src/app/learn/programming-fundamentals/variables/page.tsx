...
15`}</code>
            ...
            <section
              ...
              className="rounded-3xl bg-blue-950 p-7 text-white sm:p-9"
            >
              <p className="font-semibold text-blue-300">Knowledge check</p>

              <h2 id="knowledge-check" className="mt-2 text-2xl font-bold">
                What value will be displayed?
              </h2>

              <pre className="mt-6 overflow-x-auto rounded-xl bg-slate-950 p-5 font-mono text-blue-200">
                <code>{`let total = 5;
total = total + 3;
console.log(total);`}</code>
              </pre>

              <details className="mt-6 rounded-xl border border-blue-700 bg-blue-900/50 p-5">
                <summary className="cursor-pointer font-semibold">
                  Show the answer
                </summary>

                <p className="mt-4 leading-7 text-blue-100">
                  The answer is <strong>8</strong>. The program reads the
                  current value 5, adds 3 and assigns the result back to{" "}
                  <code>total</code>.
                </p>
              </details>
            </section>
